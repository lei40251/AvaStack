...
> 本文档是项目技术全景的快速参考，配合 [learning-path-beginner.md](learning-path-beginner.md) 实操路线图使用。路线图告诉你"怎么一步步学"，本文档提供各技术点的资源汇总。
...
| 数据库 | SQLite（开发期）→ 可迁移至 PostgreSQL | Drizzle ORM + better-sqlite3 管理会话 |
...
model-asr  →  model-tts  →  model-llm  →  admin-web  →  orchestrator  →  model-avatar
   接口清晰       结构相同      多了外部调用    前端调 API     所有服务的"大脑"   视频渲染，最后看
	   代码量少       换个名字       httpx 客户端   原生 TS        TS + Hono + 状态机
```
...
> 更详细的分步骤学习计划见 [learning-path-beginner.md](learning-path-beginner.md)。
...
| Node.js | [Node.js 官方指南](https://nodejs.org/en/learn/) |
| Hono | [Hono 文档](https://hono.dev/) |
| Vue 3 | [Vue 3 官方教程（中文）](https://cn.vuejs.org/guide/introduction.html) |
| Nuxt 3 | [Nuxt 3 文档](https://nuxt.com/docs/getting-started/introduction) |
...
> **下一步：** 打开 [learning-path-beginner.md](learning-path-beginner.md) 开始按实操路线学习。
